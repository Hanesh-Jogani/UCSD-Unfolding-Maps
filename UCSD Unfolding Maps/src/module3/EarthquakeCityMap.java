...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			int mapWidth = 750, mapHeight = 550;
	...
	private void addKey() {
		...
		float keyX = 10, keyY = 20;
		float keyWidth = 200, keyHeight = 300;
		rect(keyX, keyY, keyWidth, keyHeight);

		// Key title
		fill(0, 102, 53, 204);
		textSize(24);
		text("Earthquake Key", 10, 60);
